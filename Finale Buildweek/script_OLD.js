...
const risposte = questions[questionNumber - 1].incorrect_answers.concat(questions[questionNumber - 1].correct_answer)
...
if(questions[questionNumber - 1].correct_answer === risposteUtente[questionNumber - 1]) {
...
for(let i=0; i<questions.length; i++) {
  ...
  esito.innerHTML = risposteUtente[i] === questions[i].correct_answer? "✅": "❌"
